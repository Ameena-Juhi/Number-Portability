...
// public Map<String, Object> swaggerUiConfig(ServerHttpRequest
// serverHttpRequest) throws URISyntaxException {
// URI uri = serverHttpRequest.getURI();
// String url = new URI(uri.getScheme(), uri.getAuthority(), null, null,
// null).toString();
// Map<String, Object> swaggerConfig = new LinkedHashMap<>();
// List<AbstractSwaggerUiConfigProperties.SwaggerUrl> swaggerUrls = new
// LinkedList<>();
// System.out.println("Services = " + discoveryClient.getServices());
// discoveryClient.getServices().stream()
// .forEach(serviceName -> swaggerUrls.add(new
