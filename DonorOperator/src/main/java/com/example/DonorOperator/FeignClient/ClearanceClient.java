...
public interface ClearanceClient {
    ...
    boolean storeIdentityClearance(@RequestHeader(value = "Authorization", required = true) String authorizationHeader,
            @RequestBody ValidationClearancetoken IdentityClearance);

    @PostMapping("/deactivationClearance")
    void setDeactivationClearance(@RequestHeader(value = "Authorization", required = true) String authorizationHeader,
